    ...
    <div style={{ minHeight: "100vh", background: "#08090d", color: "#e8eaf0", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .features-grid { max-width: 900px; margin: 0 auto; padding: 40px 16px; display: grid; grid-template-columns: 1fr; gap: 14px; } display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 18px; }
